...
const Errors = require("../api/errors/frontend 2023-main-error.js");
...
const logger = LoggerFactory.get("Frontend 2023MainAbl");

class Frontend 2023MainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["frontend 2023Main"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuFrontend 2023",
        typeCode: "uu-frontend 2023-maing01",
        location: location,
...
module.exports = new Frontend 2023MainAbl();
